...
import com.batook.cbr.client.GetCursOnDateXMLResponse.GetCursOnDateXMLResult;
...
public class GetCursOnDateAccessor {
    ...
    public static class Currency {
        ...
        public String toString() {
            return String.format("Vname: %s, VchCode: %s, Vcode: %s, Vnom: %s, Vcurs: %s", vname, vchCode, vcode.toString(), vnom.toString(), vcurs.toString());
        }

        public Boolean isEmpty() {
            return StringUtils.isEmpty(vname) || StringUtils.isEmpty(vchCode) || vcode == null || vnom == null || vcurs == null;
        }
    }
}
